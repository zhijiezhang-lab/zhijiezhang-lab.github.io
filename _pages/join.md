...
## Postdocs
We are looking for a postdoc with theoretical ecology background to study the coexistence of large number of species, using the Consumer-Resource model. However, candidates with a relevant background and strong publication record should email me as there are several internal and external funding sources. 
